...
const subjects: Subject[] = [
  ...
  },
  {
    ...
    color: "bg-teal-500",
    courses: [
      { name: "Intro to Computer Science", slug: "intro-to-computer-science" },
      { name: "Intro to Programming", slug: "intro-to-programming" },
      { name: "Python", slug: "python" },
      { name: "JavaScript", slug: "javascript" },
      { name: "Object-Oriented Programming (OOP)", slug: "object-oriented-programming" },
      { name: "Data Structures", slug: "data-structures" },
      { name: "Algorithms", slug: "algorithms" },
      { name: "Computer Systems & Architecture", slug: "computer-systems-architecture" },
      { name: "Operating Systems", slug: "operating-systems" },
      { name: "Databases", slug: "databases" },
      { name: "Computer Networks", slug: "computer-networks" },
      { name: "Software Engineering", slug: "software-engineering" },
      { name: "Programming Languages & Compilers", slug: "programming-languages-compilers" },
  ...
  },
  {
    ...
    courses: [
      ...
      { name: "Investing Foundations", slug: "investing-foundations" },
      { name: "ETFs & Index Funds", slug: "etfs-index-funds" },
      { name: "Bonds & Fixed Income", slug: "bonds-fixed-income" },
      { name: "Portfolio Building & Risk Management", slug: "portfolio-building-risk-management" },
      { name: "Financial Markets & Institutions", slug: "financial-markets-institutions" },
      { name: "Banking & Financial Institutions", slug: "banking-financial-institutions" },
      { name: "Real Estate Investing", slug: "real-estate-investing" },
