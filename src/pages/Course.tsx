...
const MOCK_LESSONS: Record<string, any> = {
  ...
  "intro-to-computer-science": {
    ...
    lessons: [
      ...
      { id: 51, course_id: 10, title: "How Computers Work", slug: "how-computers-work", description: "Understanding computer hardware and processing", video_url: null, duration_seconds: 2100, order_index: 2 },
      { id: 52, course_id: 10, title: "Binary, Data, and Information", slug: "binary-data-information", description: "How computers store and represent information", video_url: null, duration_seconds: 2400, order_index: 3 },
      { id: 53, course_id: 10, title: "Algorithms and Problem Solving", slug: "algorithms-problem-solving", description: "Step-by-step problem solving", video_url: null, duration_seconds: 2400, order_index: 4 },
      { id: 54, course_id: 10, title: "Introduction to Programming", slug: "intro-programming", description: "Getting started with code", video_url: null, duration_seconds: 2400, order_index: 5 },
      { id: 55, course_id: 10, title: "Variables, Data Types, and Expressions", slug: "variables-data-types-expressions", description: "Storing and manipulating data", video_url: null, duration_seconds: 2400, order_index: 6 },
      { id: 56, course_id: 10, title: "Control Flow", slug: "control-flow", description: "Making decisions in code", video_url: null, duration_seconds: 2200, order_index: 7 },
      { id: 57, course_id: 10, title: "Loops and Iteration", slug: "loops-iteration", description: "Repeating actions efficiently", video_url: null, duration_seconds: 2200, order_index: 8 },
      { id: 58, course_id: 10, title: "Functions and Modularity", slug: "functions-modularity", description: "Organizing code into reusable parts", video_url: null, duration_seconds: 2400, order_index: 9 },
      { id: 59, course_id: 10, title: "Data Structures (Intro)", slug: "data-structures-intro", description: "Organizing and storing data", video_url: null, duration_seconds: 2400, order_index: 10 },
      { id: 60, course_id: 10, title: "Debugging, Errors, and Testing", slug: "debugging-errors-testing", description: "Finding and fixing mistakes", video_url: null, duration_seconds: 2100, order_index: 11 },
    ]
  },
  ...
  "python": {
    ...
    duration_hours: 12,
    lessons: [
      { id: 201, course_id: 12, title: "Introduction to Python", slug: "introduction-to-python", description: "Getting started with Python", video_url: null, duration_seconds: 2100, order_index: 1 },
      { id: 202, course_id: 12, title: "Python Syntax & Program Structure", slug: "python-syntax-structure", description: "Learn Python syntax basics", video_url: null, duration_seconds: 2400, order_index: 2 },
      { id: 203, course_id: 12, title: "Variables and Data Types", slug: "variables-data-types", description: "Numbers, strings, and booleans", video_url: null, duration_seconds: 2400, order_index: 3 },
      { id: 204, course_id: 12, title: "Input and Output", slug: "input-output", description: "Reading input and printing output", video_url: null, duration_seconds: 2100, order_index: 4 },
      { id: 205, course_id: 12, title: "Control Flow (Conditionals)", slug: "control-flow-conditionals", description: "If, elif, and else statements", video_url: null, duration_seconds: 2400, order_index: 5 },
      { id: 206, course_id: 12, title: "Loops and Iteration", slug: "loops-iteration", description: "For and while loops", video_url: null, duration_seconds: 2400, order_index: 6 },
      { id: 207, course_id: 12, title: "Functions", slug: "functions-python", description: "Defining and calling functions", video_url: null, duration_seconds: 2700, order_index: 7 },
      { id: 208, course_id: 12, title: "Lists and Tuples", slug: "lists-tuples", description: "Ordered collections in Python", video_url: null, duration_seconds: 2700, order_index: 8 },
      { id: 209, course_id: 12, title: "Dictionaries and Sets", slug: "dictionaries-sets", description: "Key-value pairs and unique collections", video_url: null, duration_seconds: 2700, order_index: 9 },
      { id: 210, course_id: 12, title: "Strings and Text Processing", slug: "strings-text-processing", description: "String manipulation techniques", video_url: null, duration_seconds: 2400, order_index: 10 },
      { id: 211, course_id: 12, title: "Errors, Debugging, and Exceptions", slug: "errors-debugging-exceptions", description: "Handling errors gracefully", video_url: null, duration_seconds: 2400, order_index: 11 },
      { id: 212, course_id: 12, title: "Files and Basic I/O", slug: "files-basic-io", description: "Reading and writing files", video_url: null, duration_seconds: 2400, order_index: 12 },
    ]
  },
  "javascript": {
    id: 13,
